...
import { Sidebar } from '@cloudpaste/shared/components';
import { useAuthStore, useClipboardStore } from '@cloudpaste/shared/store';
import { useWebSocket } from '@cloudpaste/shared/hooks';
import { WebSocketProvider } from '@cloudpaste/shared/contexts';
...
export default function DashboardLayout({
  ...
  return (
    <WebSocketProvider value={{ isConnected, reconnect, syncClipboard, getOnlineDevices }}>
